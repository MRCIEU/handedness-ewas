# EWAS of left-handedness: basic model, NTR adults
# V.Odintsova, J.van Dongen

library(gee)

# Load DNA methylation data (DNAm)
# Load phenotype and covariate data (covariates)

# Variabels for basic model
# familynumber
# sex
...
{
gee(CpGi~hand01+sex+age+Mono_Perc+Eos_Perc+Neut_Perc+Array_rownum+Sample_Plate,data=data, id=familynumber, family=gaussian, corstr="exchangeable", maxiter=100, na.action=na.omit,silent=TRUE)
}
#------------------------------------------------------------------------------------------------------------------------------------------------------
